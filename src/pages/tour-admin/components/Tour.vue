<template>
    <div class="wrap">
        ...
        <img src="/src/assets/btn_info.svg">
        <img src="/src/assets/btn_transition.svg">
        <div class="button">
...
.wrap {
    ...
    height: 615px;  /* высота */
    background-size: cover;    /* чтобы была одна картинка */
}
...
.button {
    ...
    align-items: flex-end;  /* элементы снизу по вертикали */
}
